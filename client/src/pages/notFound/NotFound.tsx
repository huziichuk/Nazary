                ...
                <div className={styles.content}>
                        ...
                        <div className={styles.suggestionsList}>
                            <div className={styles.suggestionItem}>
                                ...
                                <div>
                                    ...
                                    <div className={styles.suggestionText}>Make sure the address is typed correctly</div>
                                </div>
                            </div>
                            <div className={styles.suggestionItem}>
                    ...
                    <div className={styles.footer}>
                        <p className={styles.footerText}>
                            ...
                            <a href="mailto:nazar.huziichuk@gmail.com" className={styles.contactLink}> contact the developer</a>
                        </p>
                    </div>
                </div>
