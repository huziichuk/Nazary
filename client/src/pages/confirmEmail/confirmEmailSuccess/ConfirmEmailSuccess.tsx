                ...
                <div className={styles.container}>
                    <div className={styles.content}>
                        <div className={styles.successSection}>
                            ...
                            <h1 className={styles.title}>Email successfully verified!</h1>
                            <p className={styles.description}>
                                Great! Your email address has been successfully verified.
                                You can now fully enjoy all the features of Nazary.
                            </p>
                        </div>

                        <div className={styles.features}>
                            <h2 className={styles.featuresTitle}>What’s available to you now:</h2>
                        ...
                        <div className={styles.footer}>
                            <div className={styles.emailInfo}>
                                ...
                                <span>Notification emails will be sent to your verified address</span>
                            </div>
                        </div>
                    </div>
